...
const saveTodo = (e) => {
   const todo = e.target.parentElement.parentElement;
   const prevText = todo.firstChild.children[1].textContent; // value before changed
   const newText = todo.firstChild.children[2].value; // new edit value
   ...
   todo.firstChild.children[1].textContent = newText;  // change value on HTML 

   todo.classList.remove("-edited"); // delete given classes
}
...
const addHTML = (todo) => {
   ...
   todoCb.addEventListener("click", completeTodo); // direkt created event listeners
   ...
   deleteBtn.addEventListener("click", deleteTodo); // direkt created event listeners
   
   const editBtn = document.createElement("button");
   editBtn.classList.add("todo_edit");
   editBtn.textContent = "Edit";
   editBtn.addEventListener("click", editTodo); // direkt created event listeners
